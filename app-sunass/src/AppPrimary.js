        ...
        return (
            <div className="App">
                ...
                <div className="modal-dialog tam50">
                    <div className="modal-content container" style={{"minHeight":"30vh"}}>
                        <div className="modal-header row mb-2">

                            <h5 className="modal-title col-8 mb-1" style={{"textAlign":"center"}}><b>Archivos del Servidor</b></h5>

                            <button className="close col-1" onClick={this.cerrarModal}>
                            <span aria-hidden="true">&times;</span>
                            </button>
                                        ...
                                        {listadoArchivos.map((dynamicData, i) =>
                                            <tr key={i} className="row">
                                                ...
                                                <button className="btn btn-success " onClick={(e) => this.onTestSaveFile(dynamicData)} >
                                                    ...
                                                    <button className="btn  btn-danger ml-2" onClick={() => this.setState({ show: true })}>
                                                    Borrar
                                                    </button>
                ...
                {this.state.subirArchivos===true?
                    ...
                    <div className="modal-content" style={{"minHeight":"70vh"}}>
                        ...
                        <button className="close col-1" onClick={this.cerrarUpload}>
